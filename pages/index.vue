                ...
                <div class="mt-2">
                    <form class="w-full flex md:ml-0">
                        ...
                        <div class="relative text-gray-400 focus-within:text-gray-600 min-w-full">
                          ...
                          <input id="text" v-model="filter" class="py-3 px-4 bg-white placeholder-gray-400 text-gray-900 rounded-lg shadow-md appearance-none w-full block pl-12 focus:outline-none" placeholder="Search" tabindex="0" spellcheck="false" autocomplete="off" ref="search">
                        </div>
                    </form>
                </div>
