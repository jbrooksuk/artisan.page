<template>
    <div :id="slug" class="shadow-lg rounded-lg overflow-hidden">
        <div class="rounded-t-lg overflow-hidden bg-white p-10">
            <h1 class="text-lg font-semibold text-indigo-900">
            ...
            <div class="flex items-center bg-black bg-opacity-40">
                ...
                <div class="pr-8 flex-1">
                    <button
                        ...
                        <svg v-else class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
